                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap table-hover mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-primary-subtle font-size-12">Open</span>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-success-subtle font-size-12">Complete</span>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        <a class="text-muted dropdown-toggle font-size-18 px-2" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-nowrap table-centered">
                                        ...
                                        <tr>
                                            ...
                                            <td>27 May, 2020</td>
                                            <td style="width: 160px;"><span class="badge bg-primary-subtle font-size-12">Active</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>26 May, 2020</td>
                                            <td><span class="badge bg-primary-subtle font-size-12">Active</span></td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-nowrap table-centered">
                                        ...
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <td style="width: 160px;"><span class="badge bg-secondary-subtle font-size-12">Waiting</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>04 June, 2020</td>
                                            <td><span class="badge bg-primary-subtle font-size-12">Approved</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <td><span class="badge bg-secondary-subtle font-size-12">Waiting</span></td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-nowrap table-centered">
                                        ...
                                        <tr>
                                            ...
                                            <td>27 May, 2020</td>
                                            <td style="width: 160px;"><span class="badge bg-success-subtle font-size-12">Complete</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>27 May, 2020</td>
                                            <td><span class="badge bg-success-subtle font-size-12">Complete</span></td>

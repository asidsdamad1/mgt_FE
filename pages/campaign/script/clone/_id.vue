            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <button type="button" class="btn btn-outline-secondary"><i class="uil uil-arrow-circle-left me-1"></i> Quay lại</button>
                            </div>
                            <div class="col-6 text-end">
                                <button type="button" class="btn btn-success"><i class="uil uil-save me-1"></i> Lưu lại</button>
                                <button type="button" class="btn btn-primary">Công khai <i class="uil uil-arrow-circle-up ms-1"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-7">
                                <div class="mt-4 mt-xl-3 pl-xl-4">
                                    ...
                                    <h5 class="mb-4 pt-2">
                                        <del class="text-muted me-2">${{ productDetail.oldprice }}</del>
